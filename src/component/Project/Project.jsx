...
const Project = () => {
  ...
  return (
    <div id="project" className='project_head' data-aos='zoom-in' >
...
{/* *************** APPLE ********************************** */}
    <Box className='data1' style={{background: darkMode? "white" :"", color: darkMode? "black":""}}  >
           <Box className='project_content'>
            ...
            fontWeight:"600",fontSize:"1.525rem"}}>Apple Clone</Text>
            <Image src="https://media.giphy.com/media/bFSenOZndVUgDU6snh/giphy.gif"
            alt="dot&key" style={{width:"100%",borderRadius:"10px",position:"relative",transition:"opacity 0.7s 0.3s"}} />
           <Text  style={{background:"#fff",color:"#000",justifyContent:"center"}} pt='5px' pb='5px'>
           It's a group project with a team of five people. On this website, users can purchase Apple products like iPhones, Mac books, and other electronic items. I am working on the single product details page.
</Text>
          <Box style={{display:"flex" ,justifyContent:"flex-start"}} pb='5px'>
            <Text style={{color:"orange",fontSize:"19px",fontWeight:"500",width:"130px"}}>Tech Stack </Text>
         <Text pl='5px' pt='2px'>React,Redux,ChakraUI,Axios, <br/>Express,Mongodb,Node.js </Text>
          </Box>
            <Box className='show_btn'>
              <a target="_blank" rel="noreferrer" className='jss16'
              href='https://drive.google.com/file/d/1rgOBSlrRNzM2KNVS27ahvDnYna8Jf10j/view' >
              ...
              <a target={"_blank"} rel="noreferrer" className="jss16"
              href='https://client-kappa-virid.vercel.app/'>
              ...
              <a target={"_blank"} rel="noreferrer" className="jss16"
              href="https://github.com/sujeetcoder/abstracted-wren-623.git" >
              <svg stroke="currentColor" fill="currentColor" stroke-width="0"
...
{/* *************** DOT & KEY ************************ */}
        ...
        which is fully responsive, smooth UI.
          ...
          <Box style={{display:"flex" ,justifyContent:"flex-start"}} pb='5px'>
            <Text style={{color:"orange",fontSize:"19px",fontWeight:"500",width:"130px"}}>Tech Stack </Text>
         <Text pl='5px' pt='2px'>  React,Axios,ChakraUI, <br/>CSS, JavaScript, SwiperJs.</Text>
          </Box>
            <Box className='show_btn'>
              <a target="_blank" rel="noreferrer" className='jss16'
              ...
              <a target={"_blank"} rel="noreferrer" className="jss16"
              href='https://dotandkey-clone1.netlify.app/'>
              <svg viewBox="0 0 24 24" focusable="false" class="jss17" height={"1em"} width="1em">
              <g fill="currentColor">
              <path d="M23.432,10.524C20.787,7.614,16.4,4.538,12,4.6,7.6,4.537,3.213,7.615.568,10.524a2.211,2.211,0,0,0,0,2.948C3.182,16.351,7.507,19.4,11.839,19.4h.308c4.347,0,8.671-3.049,11.288-5.929A2.21,2.21,0,0,0,23.432,10.524ZM7.4,12A4.6,4.6,0,1,1,12,16.6,4.6,4.6,0,0,1,7.4,12Z"></path>
              <circle cx="12" cy="12" r="2"></circle></g></svg>
...
<Box className='data1'  style={{background: darkMode? "white" :"", color: darkMode? "black":""}}  >
      ...
      I am making by using React and ChakraUI.  
          ...
          <Box pb='5px' style={{display:"flex" ,justifyContent:"flex-start"}}>
            <Text style={{color:"orange",fontSize:"19px",fontWeight:"500",width:"140px"}}>Tech Stack </Text>
         <Text pl='5px' pt='2px'> React,Axios,ChakraUI,CSS, <br/> JavaScript, SwiperJs, Slick.</Text>
          </Box>
            <Box className='show_btn'>
              <a target="_blank" rel="noreferrer" className='jss16'
        ...
        <Box className='data1'  style={{background: darkMode? "white" :"", color: darkMode? "black":""}} >
           ...
           <Text pt='5px' pb='5px'  style={{background:"#fff",color:"#000",justifyContent:"center"}}>
        ...
        finished project in 7 days and learned a lot of new things being  part of team as a leader.
          ...
          <Box pb='5px' style={{display:"flex" ,justifyContent:"flex-start"}}>
            ...
            fontWeight:"500",width:"auto"}}>Tech Stack </Text>
         <Text pl='5px' pt='2px'> - HTML,CSS, JavaScript</Text>
          </Box>
            <Box className='show_btn'>
              <a target="_blank" rel="noreferrer" className='jss16'
        ...
        5-6 days and learned of new things being a part of team.
          ...
          <Box pb='5px' style={{display:"flex" ,justifyContent:"flex-start"}}>
            <Text style={{color:"orange",fontSize:"19px",fontWeight:"500",width:"auto"}}>Tech Stack </Text>
         <Text pl='5px' pt='2px'> -HTML,CSS,JavaScript</Text>
          </Box>
            <Box className='show_btn'>
              <a target="_blank" rel="noreferrer" className='jss16'
              ...
              <a target={"_blank"} rel="noreferrer" className="jss16"
              href="https://clockify-me-clone-lokesh.netlify.app/">
              <svg viewBox="0 0 24 24" focusable="false" class="jss17" height={"1em"} width="1em">
              <g fill="currentColor">
              <path d="M23.432,10.524C20.787,7.614,16.4,4.538,12,4.6,7.6,4.537,3.213,7.615.568,10.524a2.211,2.211,0,0,0,0,2.948C3.182,16.351,7.507,19.4,11.839,19.4h.308c4.347,0,8.671-3.049,11.288-5.929A2.21,2.21,0,0,0,23.432,10.524ZM7.4,12A4.6,4.6,0,1,1,12,16.6,4.6,4.6,0,0,1,7.4,12Z"></path>
              <circle cx="12" cy="12" r="2"></circle></g></svg>
    ...
    {/* ******************* Gearbest *********************** */}
     ...
     It is a group project -  Gearbest has got over 1 million SKUs online, more than 1,000 new arrivals per day,  providing plentiful
       shopping options for users. I am worked in sign-in and sign-up section.
          ...
          <Box mb='5px' style={{display:"flex" ,justifyContent:"flex-start"}}>
            <Text style={{color:"orange",fontSize:"19px",fontWeight:"500",width:"auto"}}>Tech Stack </Text>
         <Text pl='5px' pt='2px'> - HTML,CSS,JavaScript</Text>
          </Box>
            <Box className='show_btn'>
